(defproject fulcro-fabric-wrapper "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "fulcro_fabric_wrapper.jar"
  ...
  :cljsbuild {:builds [{:id           "production"
                        ...
                        :compiler     {:asset-path    "js/prod"
                                       :main          fulcro-fabric-wrapper.client-main
                                       :optimizations :advanced
                                       :source-map    "resources/public/js/fulcro_fabric_wrapper.js.map"
                                       :output-dir    "resources/public/js/prod"
                                       :output-to     "resources/public/js/fulcro_fabric_wrapper.js"}}]}

  :profiles {:uberjar    {:main           fulcro-fabric-wrapper.server-main
                          :aot            :all
                          ...
                          :cljsbuild    {:builds
                                         [{:id           "dev"
                                          ...
                                          {:id           "test"
                                           ...
                                           :figwheel     {:on-jsload "fulcro-fabric-wrapper.client-test-main/client-tests"}
                                           :compiler     {:asset-path    "js/test"
                                                          :main          fulcro-fabric-wrapper.client-test-main
                                                          :optimizations :none
                                          ...
                                          {:id           "automated-tests"
                                           ...
                                           :compiler     {:asset-path    "js/ci"
                                                          :main          fulcro-fabric-wrapper.CI-runner
                                                          :optimizations :none
                                          ...
                                          {:id           "cards"
                                           ...
                                           :compiler     {:asset-path           "js/cards"
                                                          :main                 fulcro-fabric-wrapper.cards
                                                          :optimizations        :none
